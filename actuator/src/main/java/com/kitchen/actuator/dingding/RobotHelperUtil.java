package com.kitchen.actuator.dingding;
...
//	private static final String ACCESS_TOKEN = "https://oapi.dingtalk.com/robot/send?access_token=4f7868c7755cadc058dd6ef545a2ea6d3adfa11698c00140f568b47646b3492e";
	private static final String ACCESS_TOKEN = "https://oapi.dingtalk.com/robot/send?access_token=dc65d20a9af09f92097a96bfe6469add1e5b8ac7ac86d7d1de099b547225608a";
	/**
	 * 消息类型
	 */
	...
	/**
	 * @description: 官方演示示例 title 是消息列表下透出的标题 text 是进入群后看到的消息内容
	 *
	 * @author: niaonao
	 * @date: 2019/7/6
	 */
	 ...
	 * @date: 2019/7/6
	 */
	public static OapiRobotSendResponse sendMessageByMarkdown(String title, String markdownText,
			List<String> mobileList, boolean isAtAll) {
		// 参数 类型 必选 说明
	 ...
	 * @date: 2019/7/6
	 */
	public static OapiRobotSendResponse sendMessageByActionCardSingle(String title, String markdownText,
			String singleTitle, String singleURL, boolean btnOrientation, boolean hideAvatar) {
		// 参数 类型 必选 说明
	 ...
	 * @date: 2019/7/6
	 */
	public static OapiRobotSendResponse sendMessageByActionCardMulti(String title, String markdownText,
	...
	/*
	 * public static void main(String args[]) { sdkDemoJava(); }
	 */
}
